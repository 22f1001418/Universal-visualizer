"""Shared LLM prompts used across multiple viz generator phases.

Phases that reference UNIVERSAL_SYSTEM_PROMPT (currently): draft,
build_loop, polish. Pulling it out of any single phase file prevents
cross-phase imports (e.g., build_loop importing from draft) and keeps
the prompt with the rest of the system-of-record copy.
"""
